...
class Order(models.Model):
    ...
    status = models.CharField(max_length=20, choices=[('pending', 'Pending'),('in_progress','In Progress'),('cancelled', 'Cancelled'),('expired', 'Expired'),('delivered', 'Delivered'),('completed', 'Completed')], default='pending')
